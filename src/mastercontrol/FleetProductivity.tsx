...
// ComplianceAlertsPanel and its AlertRow lived here until 2026-09-01. They were
// merged into FleetDocumentVault: this panel named the lorry whose paper expired
// inside 10 days but said nothing about the rest of that vehicle's file, while
// Master Document Vault said which KIND of paper expired soonest and never named
// a lorry. One row per vehicle answers both, so both were deleted rather than
// left rendering nothing.
